...
?>
    ...
    <div class="top_chapter__content">
        <div class="top_chapter__image">
            <img src=<?= $contactsA['dekan']['image_path'] ?> alt="" class="top_chapter__image">
        </div>
        <div class="top_chapter-info">
            <div class="top_chapter__text">
                <h1 class="top_chapter__title"><?= $contactsA['dekan']['post'] ?></h1>
                <p class="top_chapter__name"><?= $contactsA['dekan']['full_name'] ?></p>
            </div>
            <div class="top_chapter__contact">
                <div class="top_chapter__contact-phone">
                    ...
                    <div class="top_chapter__contact-text">
                        <a class="top_chapter__contact_phone-link" href="#"><?= $contactsA['dekan']['phone_number'] ?></a>
                    </div>
                </div>  
                <div class="top_chapter__contact-mail">
                    ...
                    <div class="top_chapter__contact-text">
                        <a class="top_chapter__contact_mail-link" href="#"><?= $contactsA['dekan']['email'] ?></a>
                    </div>
                </div>  
            </div>
        </div>
